...
def parse_args():
    ...
    parser.add_argument("--img-dir", default="data/vaihingen/train_part_images")
    parser.add_argument("--mask-dir", default="data/vaihingen/train_part_masks")
    parser.add_argument("--output-img-dir", default="data/vaihingen/train/part_images_1024")
    parser.add_argument("--output-mask-dir", default="data/vaihingen/train/part_masks_1024")
