...
road = np.array([255, 255, 0]) 
pavement = np.array([192, 192, 0 ]) 
vegetation = np.array([0, 255, 0]) 
baresoil = np.array([128, 128, 128]) 
water = np.array([0, 0, 255])
Boundary = np.array([255, 255, 255]) # label 255
num_classes = 6

CLASSES = ('buildings ', 'road', 'pavement', 'vegetation', 'baresoil', 'water')
