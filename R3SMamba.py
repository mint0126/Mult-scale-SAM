...
class RS3Mamba(nn.Module):
    def __init__(self,
        ...
        config = _cfg(url='', file='/data/shanjuan/pretrained_models/semi_weakly_supervised_resnet18-118f1556.pth') #
...
def load_pretrained_ckpt(
    model, 
    ckpt_path="/data/shanjuan/pretrained_models/vssm_base_0229_ckpt_epoch_237.pth"
):
    ...
    print('Load vmamba_base_e292 Done!')
